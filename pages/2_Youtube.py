...
#SESSION STATES
  ...
  url = st.text_input("**Paste YouTube URL** ↘️", value="", max_chars=100, key="yt_url", type="default", help=None, autocomplete=None, on_change=None, args=None, kwargs=None, placeholder="https://www.youtube.com/watch?v=8t7MUD87_Kc", disabled=False, label_visibility="visible", icon=None, width="stretch")
